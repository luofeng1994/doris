 ...
 */
@RestController
public class TableComplexQueryPlanAction extends RestBaseController {
    public static final Logger LOG = LogManager.getLogger(TableComplexQueryPlanAction.class);

    @RequestMapping(path = "/api/{" + DB_KEY + "}/{" + TABLE_KEY + "}/_complex_query_plan",
